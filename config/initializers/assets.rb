...
Rails.application.config.assets.precompile += %w( _all-skins.css )
Rails.application.config.assets.precompile += %w( bootstrap.css )
Rails.application.config.assets.precompile += %w( ionicons.css )
Rails.application.config.assets.precompile += %w( jquery-jvectormap-1.css )
...
Rails.application.config.assets.precompile += %w( jquery_002.js )
Rails.application.config.assets.precompile += %w( jquery-jvectormap-1.js )
